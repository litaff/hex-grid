...
public class GridPositionProvider : IGridPositionProvider
{
    ...
    private IReadOnlyDictionary<int, IHexStateProvider> hexStateProviders;
    ...
    {
        hexStateProviders = providers.Providers;
    }

    public void Disable()
    {
        hexStateProviders = null;
    }
    
    public void Translate(CubeHexVector offset)
    {
        if (hexStateProviders == null) return;
